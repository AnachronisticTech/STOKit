open class STOEnergyTorpedoWeapon: STOWeapon {
    ...
    internal static let specialTypes: [String: STOEnergyTorpedoWeapon.Type] = {
        return _specialTypes.reduce([String: STOEnergyTorpedoWeapon.Type]()) { (dict, type) -> [String: STOEnergyTorpedoWeapon.Type] in
            var dict = dict
            dict[String(describing: type.self)] = type.self
            return dict
        }
    }()
    private static let _specialTypes: [STOEnergyTorpedoWeapon.Type] = [
    ]
}
