...
struct EpisodeLister {
    ...
    static func ships() {
        ...
        print(ship)
        ship[fore: 1] = BeamWeapon(.BeamArray, .Phaser, .I, .Common)
        ship[fore: 2] = KineticTorpedoWeapon(.Standard, .Photon, .I, .Common)
        ship[rear: 1] = CannonWeapon(.Single, .Disruptor, .II, .Uncommon)
        print(ship)
        ship.save()
        ...
        print(newShip)
        newShip[fore: 4] = BeamWeapon(.BeamArray, .Phaser, .XV, .Epic)
        newShip[fore: 2] = BeamWeapon(.BeamArray, .Phaser, .XV, .Epic)
        newShip[fore: 3] = PhaserQuadCannons(.XV, .Epic)
        newShip[fore: 1] = KineticTorpedoWeapon(.WideAngle, .Quantum, .XV, .Epic)
        newShip[rear: 1] = CannonWeapon(.Single, .Disruptor, .II, .Uncommon)
        newShip[rear: 2] = PhotonTorpedo(.XV, .Epic)
        newShip[rear: 3] = BeamWeapon(.DualBeamBank, .Phaser, .XV, .Epic)
        newShip[rear: 4] = AncientAntiprotonOmniBeamArray(.XV, .Epic)
        newShip[eng: 1] = NeutroniumAlloy(.XV, .Epic)
        newShip[tac: 1] = PhaserRelay(.XV, .Epic)
        newShip[sci: 1] = FieldGenerator(.XV, .Epic)
